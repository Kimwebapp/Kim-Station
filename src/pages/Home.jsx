...
const Home = () => {
  ...
  useEffect(() => {
    // Imposta dinamicamente il nome del dealer nel titolo di benvenuto
    ...
    if (welcomeTitle) {
      let nome = agenteNome || dealerName || "";
      welcomeTitle.textContent = nome + ruoloPrincipale;
    }
  }, []);
  ...
  useEffect(() => {
    async function fetchAttivazioni() {
      ...
      try {
        ...
        if (!isAgente && operatore && operatore !== "all") {
